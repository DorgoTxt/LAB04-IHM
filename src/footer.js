...
const Footer = () => {
    return (
        <footer className="position-relative w-100 bg-primary text-white py-4 mt-3">
            <div className="container">
                <nav className="row">
                    {/* Logo */}
                    <a href="#" className="col-12 col-md-3 text-reset text-uppercase d-flex align-items-center justify-content-center">
                    <svg xmlns="http://www.w3.org/2000/svg" width="64" height="64" fill="currentColor" class="bi bi-pc-display-horizontal" viewBox="0 0 16 16">
